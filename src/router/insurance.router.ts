...
import {registerInsuranceController,getInsuranceController,getInsuranceByIdController,updateInsuranceController,deleteInsuranceController} from '../controllers/insurance.controller';
